...
class AccountTest {
    ...
    void testDeposit() {
        ...
        assertEquals(1005, testAccount.getBalance());
    }

    @Test
    void testWithdraw() {
        testAccount.withdraw(105);
        assertEquals(895, testAccount.getBalance());
    }
    ...
    void testMultipleDeposits() {
        ...
        testAccount.deposit(150);
        assertEquals(1300, testAccount.getBalance());
    }
    ...
    void testMultipleWithdrawals() {
        ...
        assertEquals(750, testAccount.getBalance());
    }
